...
ActiveRecord::Schema.define(version: 2019_03_25_031214) do
  ...
  create_table "products_user_products", id: false, force: :cascade do |t|
    t.bigint "user_product_id", null: false
    t.bigint "product_id", null: false
  end

  create_table "products_vendor_products", id: false, force: :cascade do |t|
